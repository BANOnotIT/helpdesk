...
- Блоги или статические сайты
- Бекэнд для мобильных приложений - тут лучше посмотреть в сторону [Firebase](https://firebase.google.com/)
- Сервер для чего-то, что должно работать 24/7, например стриминговый сервис для хомячков
