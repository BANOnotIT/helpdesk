...
- [Amazon Web Services](https://aws.amazon.com/ru/) (AWS) - Вы создаёте своё приложение каким хотите, разделяете его на небольшие кусочки (ноды) и отдаёте это всё Амазону. Он сам знает когда и сколько чего развернуть. _Оплата по времени работы и объёму*время хранения данных в хранилищах_.
