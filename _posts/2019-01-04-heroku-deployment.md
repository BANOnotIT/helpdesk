...
Если система сказала что-то плохое, а не `pip *.*.* from ***`, то есть несколько вариантов развития событий. Давайте пройдёмся по каждому:
